...
export function Search({ isDisabled, autoFocus, onClose, onClick }: SearchProps) {
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {isDisabled ? (
          <div 
            className="h-12 w-full rounded-lg border border-gray-200 bg-white pl-10 pr-10 hover:border-gray-300 hover:ring-1 hover:ring-gray-300 flex items-center cursor-pointer"
          >
            <span className="text-gray-500">Search your favorite APIs</span>
          </div>
        ) : (
          <input
            type="text"
